...
// Step 1: Define starter foods and nutrients
final starterFoods = [
  Food(
    id: '1',
    name: 'Apple',
...
// Step 2: Function to populate starter foods into Hive
Future<void> populateStarterFoods(FoodRepository repo) async {
  final foodsBox = await repo.getBox(); // Access the Hive box for foods
  if (foodsBox.isEmpty) {
    // If no foods are in the box, add the starter foods
